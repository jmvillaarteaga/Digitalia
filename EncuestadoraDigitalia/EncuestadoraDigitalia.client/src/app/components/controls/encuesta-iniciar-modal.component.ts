...
@Component({
  selector: 'app-encuesta-modal-iniciar',
  templateUrl: './encuesta-iniciar-modal.component.html',
  styleUrl: './encuesta-iniciar-modal.component.scss'
})

export class EncuestaIniciarModalComponent implements OnInit {
  ...
  @Output() grabarEncuestaRealizadaEvent = new EventEmitter<Pregunta>();

  @Output()
  afterOnInit = new EventEmitter<EncuestaIniciarModalComponent>();
