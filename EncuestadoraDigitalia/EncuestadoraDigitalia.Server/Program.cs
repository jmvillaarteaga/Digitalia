...
using EncuestadoraDigitalia.Server.Configuration;
using EncuestadoraDigitalia.Server.Services;
using EncuestadoraDigitalia.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - EncuestadoraDigitalia";
